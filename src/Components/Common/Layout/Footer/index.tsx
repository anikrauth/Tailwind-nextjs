...
export default function Footer() {
  return (
        ...
        <div className="mb-6 md:mb-0">
          <Link href="/">
            <a className="flex items-center">
                ...
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Goonut</span>
            </a>
            </Link>
        </div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" className="hover:underline">Goonut™</a>. All Rights Reserved.
        </span>
